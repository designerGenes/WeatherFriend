...
struct MockWeatherType: WeatherType {
    ...
    static func mock() -> MockWeatherType {
        return MockWeatherType(condition: WeatherCondition.breezy, humidity: 0.6, temperature: .init(value: 55, unit: .fahrenheit), windDirection: Wind.CompassDirection.east, windSpeed: Measurement(value: 10, unit: .metersPerSecond))
    }
}
